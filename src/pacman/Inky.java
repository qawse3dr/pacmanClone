...
public class Inky extends ghost{
	...
	public void draw(Graphics g) {
		...
		currentSprite(this);
		g.drawImage(ghost.ghostSpriteSheet, (int)x, (int)y-5, (int)x+27, (int)y+22, spriteSheetX*16, spriteSheetY*16, spriteSheetX*16+16, spriteSheetY*16+16, null);
	...
	public void tick() {
		...
		if (dead){
			...
			if (player.currentMove == movement.up){
				...
				targetX = (int) (Math.abs(player.currentX-ghost.ghosts[0].x)*2+ghost.ghosts[0].x);
				targetY= (int) (Math.abs(player.currentY-32-ghost.ghosts[0].y)*2+ghost.ghosts[0].y);
			}else if (player.currentMove == movement.down){
				targetX = (int) (Math.abs(player.currentX-ghost.ghosts[0].x)*2+ghost.ghosts[0].x);
				targetY= (int) (Math.abs(player.currentY+32-ghost.ghosts[0].y)*2+ghost.ghosts[0].y);
			}else if (player.currentMove == movement.left){
				targetX = (int) (Math.abs(player.currentX-32-ghost.ghosts[0].x)*2+ghost.ghosts[0].x);
				targetY= (int) (Math.abs(player.currentY-ghost.ghosts[0].y)*2+ghost.ghosts[0].y);
